...
template <> constexpr inline auto GameEngine::qt_create_metaobjectdata<qt_meta_tag_ZN10GameEngineE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'scenarioVictory'
        QtMocHelpers::SignalData<void(ScenarioId)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 9, 10 },
        }}),
        // Signal 'scenarioDefeat'
        QtMocHelpers::SignalData<void(ScenarioId)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 9, 10 },
        }}),
        // Signal 'combatResult'
        QtMocHelpers::SignalData<void(bool, int, int)>(12, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 13 }, { QMetaType::Int, 14 }, { QMetaType::Int, 15 },
        }}),
        // Signal 'flagSet'
...
void GameEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->scenarioVictory((*reinterpret_cast<std::add_pointer_t<ScenarioId>>(_a[1]))); break;
        case 3: _t->scenarioDefeat((*reinterpret_cast<std::add_pointer_t<ScenarioId>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameEngine::*)(const StoryNode * )>(_a, &GameEngine::nodeChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameEngine::*)(int , int )>(_a, &GameEngine::statsChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameEngine::*)(ScenarioId )>(_a, &GameEngine::scenarioVictory, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameEngine::*)(ScenarioId )>(_a, &GameEngine::scenarioDefeat, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameEngine::*)(bool , int , int )>(_a, &GameEngine::combatResult, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameEngine::*)(const QString & )>(_a, &GameEngine::flagSet, 5))
            return;
    }
}
...
// SIGNAL 0
void GameEngine::nodeChanged(const StoryNode * _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void GameEngine::statsChanged(int _t1, int _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1, _t2);
}

// SIGNAL 2
void GameEngine::scenarioVictory(ScenarioId _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void GameEngine::scenarioDefeat(ScenarioId _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 3, nullptr, _t1);
}

// SIGNAL 4
void GameEngine::combatResult(bool _t1, int _t2, int _t3)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 4, nullptr, _t1, _t2, _t3);
}

// SIGNAL 5
void GameEngine::flagSet(const QString & _t1)
{
